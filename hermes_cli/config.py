...
OPTIONAL_ENV_VARS = {
    ...
    # NOTE (P-006): Chinese community edition adds env-var metadata for CN
    # providers that upstream does not list in OPTIONAL_ENV_VARS.  Without
    # this, the dashboard /api/env panel cannot surface ARK / COMPSHARE /
    # QIANFAN / HUNYUAN / SILICONFLOW / MODELSCOPE / AI302 with description,
    # docs URL, or password masking.  Source: v2/patches/runtime/P-006-...
    "ARK_API_KEY": {
    ...
    "ARK_BASE_URL": {
        "description": "火山方舟 base URL override (default: https://ark.cn-beijing.volces.com/api/v3)",
        "prompt": "火山方舟 base URL (leave empty for default)",
        "url": None,
        "password": False,
        "category": "provider",
        "advanced": True,
